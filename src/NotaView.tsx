    ...
    <section className="px-margin-mobile lg:px-margin-desktop py-8 max-w-container-max mx-auto w-full flex-grow">
      {isAdmin ? (
                      ...
                      <tr key={item.product.id}>
                        ...
                        <td className="px-3 py-2 text-right">
                          <button
                            ...
                            className="p-1 text-slate-400 hover:text-rose-600 active:scale-95 transition-all rounded-md hover:bg-rose-50"
                            title="Hapus Item"
                          >
        ...
        <div className="text-center py-16 text-secondary">
          <svg className="w-10 h-10 text-slate-400 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
